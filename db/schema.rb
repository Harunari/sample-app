...
ActiveRecord::Schema.define(version: 20_190_124_140_036) do
  create_table 'favorite_microposts', force: :cascade do |t|
    t.integer 'subscriber_id'
    t.integer 'micropost_id'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['micropost_id'], name: 'index_favorite_microposts_on_micropost_id'
    t.index %w[subscriber_id micropost_id], name: 'index_favorite_microposts_on_subscriber_id_and_micropost_id', unique: true
    t.index ['subscriber_id'], name: 'index_favorite_microposts_on_subscriber_id'
  end
